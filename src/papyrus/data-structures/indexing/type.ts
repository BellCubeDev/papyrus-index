...
export const UnknownPapyrusScriptStruct: unique symbol = memoizeDevServerConst('UnknownPapyrusScriptStruct', ()=>Symbol.for('PAPYRUS_INDEX_UnknownPapyrusScriptStruct')) as never;
