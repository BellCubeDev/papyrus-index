        ...
        <SuspenseIfDevelopment fallback={null}>
            {(async (): Promise<Graph['@graph']> => {
                ...
                return [
                    {
                        "@type": "APIReference",
                        "@id": `https://papyrus.bellcube.dev${prepareUrlParts(game, 'script', scriptBySources[AllSourcesCombined].namespaceName[0]![1], 'function', func.name[0]![1])}#function`,
                        ...
                        mainEntityOfPage: { "@id": `https://papyrus.bellcube.dev${prepareUrlParts(game, 'script', scriptBySources[AllSourcesCombined].namespaceName[0]![1], 'function', func.name[0]![1])}#function` },
                        ...
                        about: { "@id": `https://papyrus.bellcube.dev${prepareUrlParts(game, 'script', scriptBySources[AllSourcesCombined].namespaceName[0]![1], 'function', func.name[0]![1])}#code` },
                        name: getBestStringVariant(func.name)![1],
                    ...
                    } satisfies APIReference,
                    {
                        ...
                        codeSampleType: "function",
                        name: getBestStringVariant(func.name)![1],
                        description: await FunctionDocumentationStringRaw({game, func, scriptName: scriptNamespaceName}),
                    } satisfies SoftwareSourceCode,
                    {
                        "@type": "BreadcrumbList",
                        "@id": `https://papyrus.bellcube.dev${prepareUrlParts(game, 'script', scriptBySources[AllSourcesCombined].namespaceName[0]![1], 'function', func.name[0]![1])}#breadcrumb`,
                        itemListElement: [
                            {
                                "@type": "ListItem",
                                position: 1,
                            ...
                            },
                            {
                                ...
                                position: 4,
                                name: getBestStringVariant(func.name)![1],
                                item: `https://papyrus.bellcube.dev${prepareUrlParts(game, 'script', scriptBySources[AllSourcesCombined].namespaceName[0]![1], 'function', func.name[0]![1])}`,
                            },
                        ],
                    },
                ];
