...
async function getWikiFunctionShortDescriptionMD__Server<TGame extends PapyrusGame>(game: TGame, func: (SearchEntityFunctionIndexed<TGame>|PapyrusScriptFunctionIndexedAggregate<TGame>|PapyrusScriptFunctionIndexed<TGame>) & {ckWikiDescription?: string|null|undefined}, scriptName: string): Promise<string | null> {
...
export function useGetWikiFunctionShortDescriptionMD<TGame extends PapyrusGame>(game: TGame, func: (SearchEntityFunctionIndexed<TGame>|PapyrusScriptFunctionIndexedAggregate<TGame>|PapyrusScriptFunctionIndexed<TGame>) & {ckWikiDescription?: string|null|undefined}, scriptName: string): string | null {
