; File included in JContainers to supplement their Domains feature. See their wiki for more information on Domains:
;
; https://github.com/ryobg/JContainers/wiki/Domains}
