# papyrus-index-vscode-language-dev-ext

This folder contains a simple VS Code extension to debug the TextMate grammar definition we use for the Papyrus language.
...
* `syntaxes/papyrus.tmlanguage.json` - this is the Text mate grammar file that is used for tokenization.
